...
public class DoctorContextFactory extends DefaultContextFactory {
	...
	public DoctorContextFactory(ContextParser parser) {
		super(parser);
	}
	...
	public ModuleContext createContext() {
		...
		try {
			File certFile = null;
			URL certificationResource = DoctorContextFactory.class.getResource(MYCERTIFICATE_DEF_FOLDER);
