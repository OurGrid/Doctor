...
public class DoctorAsyncInitializationContext implements 
		InitializationContext<BrokerManager, DoctorAsyncManagerClient> {

	public DoctorAsyncManagerClient createManagerClient() {
		return new DoctorAsyncManagerClient();
	}
